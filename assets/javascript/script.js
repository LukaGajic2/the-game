...
function playerGame(playerResult) {
	...
	player.innerHTML = `<img src="assets/images/${playerResult}-image.png" class="result-icon" alt="player-result"></img>`;
	computer.innerHTML =`<img src="assets/images/${computerResult}-image.png" class="result-icon" alt="computer-result"></img>`;
